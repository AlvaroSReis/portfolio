      ...
      <header id="home">
         <nav id="nav-wrap">
          ...
          <a className="mobile-btn" href="#" title="Hide navigation">Hide navigation</a>
            <ul id="nav" className="nav">
               ...
               <li><a className="smoothscroll" href="#portfolio">Projetos Desenvolvidos</a></li>
         ...
         <div className="row banner">
            <div className="banner-text">
               ...
               <h3 style={{color:'#fff', fontFamily:'sans-serif '}}>Eu sou um {resumeData.role}.{resumeData.roleDescription}
               </h3>
               <hr/>
               <ul className="social">
                  {
